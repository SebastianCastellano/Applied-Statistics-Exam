...
x11()
plot(cumsum(pca$sdev^2)/sum(pca$sde^2), type='b', xlab='number of components', ylab='contribution to the total variance', ylim=c(0,1))
abline(h=0.8, col="grey")
var.explained <- pca$sdev^2

#e) Project a new sample on the space generated by the chosen principal components
